...
export default function ContactFormular() {
  return (
    <div
      ...
      className="grid md:grid-cols-5 bg-[#E9E9E9] rounded-lg p-4 space-y-10 md:space-y-0 md:p-12 my-12"
    >
      <div className="md:p-12 col-span-2 space-y-4">
        <h1 className="text-4xl font-[SagaceMedium] text-[#FF5724]">
          We’ve been<br /> waiting for you!
        </h1>
        <p className="text-lg font-[NeueHaasRoman]">
