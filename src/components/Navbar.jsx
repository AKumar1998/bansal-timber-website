...
export default function Navbar() {
  ...
  return (
    ...
    >
      <nav className="group relative flex items-center justify-between px-6 py-4 bg-black md:bg-black rounded-2xl mx-4 md:mx-auto max-w-7xl transition-colors duration-300 hover:bg-white">
        {/* Logo */}
